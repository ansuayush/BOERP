            ...
            if (quesArray[i].IsAudit == false) {
                for (let j = 0; j < optionText.length; j++) {
                    option = option +
                        ...
                        '<input name="option' + quesArray[i].Id + '" type="radio" class="radio" id="Option' + optionText[j].ID + '" onchange="handleError(' + quesArray[i].Id + ')" >' +
                        '<label for="Option' + optionText[j].ID + '" class="radio">' + optionText[j].OptionText + '</label>' +
                        '</div>' +
                        '</li>';
                }
            }
                ...
                for (let j = 0; j < optionText.length; j++) {
                    if (optionText[j].IsSelect == true) {
                        option = option +
                            '<li class="singleselect">' +
                            '<div class="radio rediodgn">' +
                            '<input name="option' + quesArray[i].Id + '" type="radio" class="radio" class="radio" id="Option' + optionText[j].ID + '"  checked >' +
                            '<label for="Option' + optionText[j].ID + '" class="radio">' + optionText[j].OptionText + '</label>' +
                            '</div>' +
                            '</li>';
                    }
