$(document).ready(function () {
    ...
    CommonAjaxMethod(virtualPath + 'Generic/GetRecordsAsync', { modelData: jsonString, screenId: 'GRNEntry_101' }, 'GET', function (response) {
        ...
        $('#pGRNNumber').html(tblDoc[0].DOC_PreFix + "/" + tblDoc[0].DOC_SERIES + "-" + tblDoc[0].DocNumber);
...
function RedirectToEdit() {
    ...
    var url = "../../MaterialManagement/Material/CreateGrn?auth=" + AuthToken + "&id=" + $('#hdnPoId').val() + "&suppId=" + $('#hdnSuppId').val();
...
function printGRNOrder(GRN_Id) {

    var GRNDocNo = $('#lblDocNumber').text();
    $.ajax({
