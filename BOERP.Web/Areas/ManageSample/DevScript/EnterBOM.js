...
function BindData() {
    ...
    if ($.fn.DataTable.isDataTable("#sampleStep5")) {
        indentTable.ajax.reload();
        return;
    }

    indentTable = $('#sampleStep5').DataTable({
        "processing": true,
        "serverSide": true,
        "paging": true,
        ...
        "columns": [
            ...
            },
            {
                ...
                "render": function (data, type, row) {
                    ...
                    return `<strong class="text-primary">Task 5</strong> <span class="d-block">Enter BOM</span>`;
                ...
                "render": function (data, type, row) {
                    ...
                    return `<div class="dropdown">
                            ...
                            <div class="dropdown-menu actionmenu" aria-labelledby="dropdownMenuButton">
                                <a class="dropdown-item" onclick="StoreChemistName('${String(row.Chemist)}', '${String(row.SampleType)}', ${row.BOM_ID})" href="EnterFormulationForSample?auth=${AuthToken}&id=${row.Id}">Mark Done</a>
                                ${viewDetails}
                            </div>
                        </div>`;
