...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function bindItemMasterGrid() {
        ...
        CommonAjaxMethod(virtualPath + 'Generic/GetPagingRecordsAgGridAsync', requestData, 'GET', function (response) {
            ...
            gridOptions = bindAgGrid("#myGrid", 'DispatchStatus', columnMeta, tableData);
            $("#customLoader").hide();
        });
    }
...
function CreateItem(Id) {
    ...
    window.location.href = `/MaterialManagement/Material/ItemMaster?auth=${AuthToken}&itemId=0&IsSample=1`;
