$(document).ready(function () {
    ...
    let selectedValue = localStorage.getItem('PcData') ? localStorage.getItem('PcData') : 1;
...
async function viewTask(rowId, StepNo, fms_id) {
    ...
    CommonAjaxMethod(virtualPath + 'Generic/GetRecordsAsync', { modelData: jsonString, screenId: 'ERP_PCFMS_102' }, 'GET', function (response) {
        ...
        if (data.IsPermitUser == 0) {
            FailToaster('You dont have the permission to view this step!!!');
            return;
        }
...
function getOilULStep3(rowId, IsView, StepNo) {
    ...
    <div class="col-lg-12 form-group" style="display: none;" id="view_att">
        <div class="card br-none p-0">
            <div class="card-header border-top-RL header-active br-none  d-flex justify-content-between ">
                <h2 class="title-two align-self-center">Upload Items</h2>
                <div class="align-self-center"></div>
            </div>
    ...
    ///* ------------------- APPEND: initialize file upload for dynamically added elements ------------------- */
    //// initialize any .drag-area inside the new markup (avoid double init using data attribute)
    //$('#dynamic_fms').find('.drag-area').each(function () {
    //    var area = this;
    //    if (!area.dataset.uploadInit) {
    //        // call your existing function which expects the drop area element
    //        // fileUploadWithPreview(dropArea) must be defined elsewhere in your code
    //        try {
    //            fileUploadWithPreview(area);
    //            area.dataset.uploadInit = '1'; // mark initialized
    //        } catch (e) {
    //            console.error('fileUpload init failed for area', e);
    //        }
    //    }
    //});
    ...
    if (!window._qctestUploadModalBound) {
        $(document).on('shown.bs.modal', '#qctestmappingInitiated', function () {
            $(this).find('.drag-area').each(function () {
                if (!this.dataset.uploadInit) {
                    try {
                        fileUploadWithPreview(this);
                        this.dataset.uploadInit = '1';
                    } catch (err) {
                        console.error('fileUpload init on shown failed', err);
                    }
                }
            });
        });
...
function ShowQCMappingInitiatedOil(sampleId, IsView) {
    ...
    CommonAjaxMethod(virtualPath + 'Generic/GetRecordsAsync', { modelData: jsonString, screenId: ScreenID }, 'GET', function (response) {
        ...
        BindTableQCTestInitiatedOil(data);
...
function BindTableQCTestInitiatedOil(filteredData) {
    ...
    if (parseInt(itemId) > 0) {
        ...
        CommonAjaxMethod(virtualPath + 'Generic/GetRecordsAsync', { modelData: jsonString, screenId: 'Oil_Sample_101' }, 'GET', function (response) {
            ...
            for (let i = 0; i < arr.length; i++) {
                if (i == 0) {
                    BindHTMLTableQualityParametersOil(0);
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 form-group">
                        ...
                        <div class="input-group">
                            ...
                            <div class="input-group-append bg-bgl">
                                <span class="input-group-text w-60 d-flex align-self-centre d-flex justify-content-center" ${disabled}>
                                    <select id="unit_avail_ul" class="form-control hidesearchselect  applyselect">
                                        <option value="ml">ml</option>
                                        <option value="gm">gm</option>
                                    </select>
                                </span>
...
function BindHTMLTableQualityParametersOil(docID) {
...
function getSampleStep7(rowId, IsView, StepNo) {
    ...
    <div class="modal-dialog modal-dialog-centered modal-md">
        <div class="modal-content ">
            <!-- Modal Header -->
            <div class="modal-header">
                <h4 class="modal-title text-left w-100" id="last_header">Step 7 - Enter Customer Feedback</h4>
...
`
    ...
    if ($('#ddlFMS').val() == 3) {
        $('#last_header').html('Step 4 - Enter Customer Feedback')
    }
    else if ($('#ddlFMS').val() == 4) {
        $('#last_header').html('Step 5 - Enter Customer Feedback')
    }
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 form-group">
                        ...
                        <div class="d-flex flex-wrap gap-50 mt-2">
                            <input type="radio" id="normal" class="radio openModal" name="radio-group">
                            <label for="normal">Normal</label>
                            <input type="radio" id="urgent" class="radio" name="radio-group">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body mb-100" >
        ...
        <div class="row">
          ...
          <div class="col-sm-12 form-group">
            <label for="state" class="mb-0">Assigned CRR<sup>*</sup></label>
            ...
            `<div class="col-sm-12 form-group">
                    ...
                    <div class="section-container section-container-popup">
							        <div class="fileuploadview drag-area p-0 drag-area1">
							           ...
							           <input type="file" id="fileAttachment1" class="file-input hidden" multiple accept=".psd,.ai"/>
                  ...
                  <div class="col-sm-12 form-group">
                   ...
                   <div class="section-container section-container-popup">
							        <div class="fileuploadview drag-area p-0 drag-area2">
							           ...
							           <input type="file" id="fileAttachment2" class="file-input hidden" multiple  accept=".psd,.ai"  />
...
function SaveStep8(orderId, StepNo) {
    if (checkValidationOnSubmit('MandateStep8') == true) {
        const model = {
            OrderId: orderId,
